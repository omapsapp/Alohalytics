...
# $iosDeviceInfo [ 
# browserUserAgent=Mozilla/5.0 (iPhone; CPU iPhone OS 10_3 like Mac OS X) AppleWebKit/603.1.30 (KHTML, like Gecko) Version/10.0 Mobile/14E269 Safari/602.1 
...
class DeviceInfo(DictEvent):
    ...
    def os_version(self):
        try:
            if self.key == '$androidDeviceInfo':
                return androidVersions[self.data['build_version_sdk']]
            elif self.key == '$iosDeviceInfo':
