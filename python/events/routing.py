from .base import _PairsEvent, Event


class RouteRequest(_PairsEvent):
	keys = (
	...
	def __init__(self, *args, **kwargs):
		...
		self.mode = self.data.get('name', self.data.get('router'))  # vehicle, astar-bidirectional-pedestrian
